...
class BoatsControllerTest < ActionController::TestCase
  ...
  test "should create boat" do
    assert_difference('Boat.count') do
      post :create, boat: { bname: @boat.bname, containers: @boat.containers, location: @boat.location, user_id: @boat.user_id }
    end
  ...
  test "should update boat" do
    patch :update, id: @boat, boat: { bname: @boat.bname, containers: @boat.containers, location: @boat.location, user_id: @boat.user_id }
    assert_redirected_to boat_path(assigns(:boat))
  end
